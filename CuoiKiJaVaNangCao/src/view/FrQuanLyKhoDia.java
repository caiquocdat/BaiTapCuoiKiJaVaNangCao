...
public class FrQuanLyKhoDia extends javax.swing.JFrame {
    ...
    public void fillTextMaDonHang() {
        for (QuanLyKhoDia ee : dao.GiaTriHangCuoi()) {
            String cpChuoi = ee.getMaDia().substring(3).trim();
            int cpSo = Integer.valueOf(cpChuoi) + 1;
            String maHD = "Dia" + String.valueOf(cpSo);
            txt_maDia.setText(maHD);
        }
    }

    public boolean kiemTraTenDia() {
        for (QuanLyKhoDia ee : dao.getAllDia()) {
            if (ee.getTenDia().trim().equals(txt_tenDia.getText())) {
                return true;
            }
        }
        return false;
    ...
    private void initComponents() {
        ...
        btn_lamMoi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/refresh (1).png"))); // NOI18N
    ...
    private void btn_luuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_luuActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            if (validateForm()) {
                ...
                try {
                    if (kiemTraTenDia()) {
                        JOptionPane.showMessageDialog(this, "Tên Đĩa đã tồn tại!!!");
                    } else {
                        if (dao.add(ee) > 0) {
                            fillDatabase();
    ...
    private void btn_timKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_timKiemActionPerformed
        ...
        if (txt_timKiem.getText().isEmpty() || txt_timKiem.getText().equals("Nhập MaDia")) {
            ...
            model.setRowCount(0);
            for (QuanLyKhoDia ee : dao.getAllDia()) {
                if ((ee.getTenDia().trim()).contains(txt_timKiem.getText())) {
