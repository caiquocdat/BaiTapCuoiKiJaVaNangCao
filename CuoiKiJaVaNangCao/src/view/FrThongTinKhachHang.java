...
public class FrThongTinKhachHang extends javax.swing.JFrame {
    ...
    public void fillTextMaDonHang() {
        for (ThongTinKhachHang ee : dao.GiaTriHangCuoi()) {
            String cpChuoi = ee.getMaKH().substring(2).trim();
            int cpSo = Integer.valueOf(cpChuoi) + 1;
            String maHD = "KH0" + String.valueOf(cpSo);
            txt_maKhachHang.setText(maHD);
        }
    }

    public boolean kiemTraTenDia() {
        for (ThongTinKhachHang ee : dao.getAllKH()) {
            if (ee.getTenKH().trim().equals(txt_tenKhachHang.getText())) {
                return true;
            }
        }
        return false;
    ...
    private void btn_timKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_timKiemActionPerformed
        ...
        if (txt_timKiem.getText().isEmpty() || txt_timKiem.getText().equals("Nhập MaNV")) {
            ...
            model.setRowCount(0);
            for (ThongTinKhachHang ee : dao.getAllKH()) {
                if ((ee.getTenKH().trim()).contains(txt_timKiem.getText())) {
